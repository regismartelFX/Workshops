  ...
  parameters = <<PARAMETERS
{
  ...
  "logsEnabled": {
    ...
    "metadata": {
      ...
      "description": "DUMMY PARAMETER! NOT USED IN THE POLICY DEFINITION.  USED HERE TO ALLOW THE POLICY TO BE USED IN AN INITIATIVE WITH A COMMON SET OF PARAMETERS. Whether to enable logs stream to the Log Analytics workspace - True or False"
    },
    "allowedValues": [
      "True",
      "False"
